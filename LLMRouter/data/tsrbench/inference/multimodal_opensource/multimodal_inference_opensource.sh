...
DATASETS=(
  datasets/TSRBench/perception/perception.jsonl
  datasets/TSRBench/reasoning/temporal_relation_reasoning.jsonl
  datasets/TSRBench/reasoning/inductive_reasoning.jsonl
  datasets/TSRBench/reasoning/numerical_reasoning.jsonl
  datasets/TSRBench/reasoning/causal_reasoning.jsonl
  datasets/TSRBench/reasoning/etiological_reasoning.jsonl
  datasets/TSRBench/reasoning/abductive_reasoning.jsonl
  datasets/TSRBench/reasoning/deductive_reasoning.jsonl
  datasets/TSRBench/prediction/time_series_forecasting.jsonl
  datasets/TSRBench/prediction/event_prediction.jsonl
  datasets/TSRBench/decision/qualitative_decision.jsonl
  datasets/TSRBench/decision/quantitative_decision.jsonl
)
...
for MODEL in "${MODELS[@]}"; do
  ...
  for DATASET in "${DATASETS[@]}"; do
    ...
    if [[ "$DATASET" == *"abductive_reasoning"* ]]; then
      ...
      EVAL_SCRIPT="${SCRIPT_DIR}/multimodal_inference_opensource_abductive.py"
      ...
      EVAL_SCRIPT="${SCRIPT_DIR}/multimodal_inference_opensource.py"
