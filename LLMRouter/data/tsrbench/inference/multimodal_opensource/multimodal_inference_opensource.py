...
parser.add_argument("--openai-api-key", type=str, default="EMPTY", help="API key (EMPTY for local vLLM)")
parser.add_argument("--openai-base-url", type=str, default="http://localhost:8000/v1", help="OpenAI-compatible base URL (local vLLM server)")
