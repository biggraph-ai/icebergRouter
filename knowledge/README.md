# Persistent study outputs
Populate one short, source-linked note per repository, plus:
- source-map.md: concept -> repo -> commit -> file/symbol.
...
Keep notes concise enough for a new coding session to read before retrieving the relevant source files. Notes do not replace code evidence. Do not index data, weights, build outputs, dependency trees or secrets into an agent prompt.
